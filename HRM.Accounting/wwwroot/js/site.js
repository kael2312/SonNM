...
function loadQuickEdit(obj) {
    ...
    $('#modalUpdateData .modal-footer .btn-submit-popup').unbind('click');
    ...
    var submit_title = $(obj).attr('submit-title');
    if (submit_title != undefined)
        $('#modalUpdateData .modal-footer .btn-submit-popup').html(submit_title);
    ...
    options.success = function (data) {
        ...
        if (data) {
            ...
            $('#modalUpdateData .modal-body form').validate({
                validClass: "valid",
                errorClass: "input-validation-error",
            });

            $('#modalUpdateData .modal-footer .btn-submit-popup').click(function (e) {
                e.preventDefault();
                addOverlay('#modalUpdateData .modal-body', 3000);
                ...
                if (pform.valid()) {
                    ...
                    removeOverlay('#modalUpdateData .modal-body');
                    toastr.warning("Invalid input, Please fill required fields!");
                }
            });
        }
    };
...
function formatCurrency(val, currency, digit) {
